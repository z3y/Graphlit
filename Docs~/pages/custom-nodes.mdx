...
Custom function parser is currently not very advanced. Some inputs and outputs might fail to parse, like using arrays etc.
</Callout>

To add custom function nodes to the graph search tree menu create an .hlsl and add a `ZSGFunction` tag.
...
More examples can be found [here](https://github.com/z3y/ShaderGraphZ/tree/master/Editor/ShaderNode/Nodes/Functions).